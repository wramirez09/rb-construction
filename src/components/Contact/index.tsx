...
const Contact = () => {
	return (
		<section id="contact" className="relative py-20 md:py-[120px]">
			...
			<div className="absolute left-0 top-0 -z-[1] h-1/2 w-full bg-[#fff] dark:bg-dark-700 lg:h-[45%] xl:h-1/2"></div>
						...
						<div className="ud-contact-content-wrapper">
							<div className="ud-contact-title mb-12 lg:mb-[150px]">
								<span className="mb-6 block text-base font-medium text-dark dark:text-white">
									Have questions or ready to start your project? Contact us
									today for personalized assistance and free estimates!
								</span>
							...
							<div className="mb-12 flex flex-wrap justify-between lg:mb-0">
								<div className="mb-8 flex w-[1/4] max-w-full">
								...
								<div className="mb-8 flex w-[1/4] max-w-full">
									...
									<div>
										...
										<a href="tel:12245004842" className="">
											<ul>224 500 4842</ul>
										</a>
									</div>
								</div>
								<div className="mb-8 flex w-[1/4] max-w-full">
									...
									<div>
										...
										<a
											href="mailto:sales@1stoppropertymaintenance.com"
											className="mt-1 text-base text-body-color dark:text-dark-6 lowercase"
										>
											sales@1stoppropertymaintenance.com
										</a>
									</div>
								</div>
							</div>
